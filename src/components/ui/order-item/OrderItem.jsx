...
const OrderItem = ({ selectedProduct }) => {
    const items = JSON.parse(selectedProduct);
    return (
        ...
        <div className={styles.orderItem_container}>
            ...
            <button className={styles.deleteOrderItem} >
            ...
            <div className={styles.add_delete}>
                {/* <button className={button_item} onClick={() => addPhoneInCart(id)}>+</button> */}
                <button className={styles.button_item} >+</button>
                <span className={styles.count}></span>
                <button className={styles.button_item} >-</button>
                {/* <button className={styles.button_item} onClick={() => removePhoneFromCart(id)}>-</button> */}
            </div>
            <p></p>
        </div>
    )
